# --
# Kernel/System/DynamicField/Backend/AutocompleteText.pm - Delegate for DynamicField Text backend
...
package Kernel::System::DynamicField::Backend::AutocompleteText;
...
Kernel::System::DynamicField::Backend::AutocompleteText
...
sub EditFieldRender {
    ...
    $Self->{Foo} = 'something'; 
    my $HTMLString = <<"EOF";
<input type="text" class="W75pc $FieldClass" id="$FieldName" name="$FieldName" title="$FieldLabel" value="$Value" />
    ...
    \$(function() {
        ...
        \$('#$FieldName').autocomplete({
            ...
            source: function( request, response ) { 
                ...
                \$.getJSON( "\$Env{"Baselink"}Action=DynamicFieldAutocompleteText&Subaction=$FieldConfig->{AutocompleteType}", request, function( data, status, xhr ) { 
                    cache[ term ] = data; 
                    response( data );
                });
            }
