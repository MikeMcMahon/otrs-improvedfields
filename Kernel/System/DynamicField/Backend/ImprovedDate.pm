# --
# Kernel/System/DynamicField/Backend/ImprovedDate.pm - Delegate for DynamicField Date backend
...
package Kernel::System::DynamicField::Backend::ImprovedDate;
...
Kernel::System::DynamicField::Backend::ImprovedDate
...
sub new {
    ...
    # allocate new hash for objectadd
    my $Self = {};
    bless( $Self, $Type );
...
sub EditFieldRender {
	...
	# For generic agents and other we must make the user check the stupid box... 
	my $IsOptional = 0; 
    ...
    my $HTMLString = $Param{LayoutObject}->BuildDateSelection(
        ...
        $FieldName . Optional => $IsOptional, # Improved dates are always required (UNLESS ITS A FREAKING GenericAgent...)!
        Validate              => 0,
        %{$FieldConfig},
        %SplitedFieldValues,
        %YearsPeriodRange,
