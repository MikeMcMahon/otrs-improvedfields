# --
# Kernel/Modules/AdminDynamicFieldImprovedDateTime.pm - provides a dynamic fields Date Time config view for admins
# Copyright (C) 2013 Mike McMahon, http://mikemcmahon.github.io
# --
# $Id: AdminDynamicFieldImprovedDateTime.pm,v 1.23 2012/11/20 14:37:03 mh Exp $
# --
...
package Kernel::Modules::AdminDynamicFieldImprovedDateTime;
...
sub _ShowScreen {
    ...
    $Output .= $Self->{LayoutObject}->Output(
        TemplateFile => 'AdminDynamicFieldImprovedDateTime',
        Data         => {
            %Param,
