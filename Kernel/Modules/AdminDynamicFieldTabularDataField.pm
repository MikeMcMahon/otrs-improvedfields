# --
# Kernel/Modules/AdminDynamicFieldTabularDataField.pm - provides a dynamic fields text config view for admins
# Copyright (C) 2013 Mike McMahon, http://mikemcmahon.github.io
# --
# $Id: AdminDynamicFieldTabularDataField.pm,v 1.32 2012/11/20 14:37:27 mh Exp $
# --
...
package Kernel::Modules::AdminDynamicFieldTabularDataField;
...
sub _ShowScreen {
    ...
    for my $Key ( sort keys %PossibleValues ) {
        ...
        $Self->{LayoutObject}->Block(
            ...
            Data => {
                ...
                ValueErrorStrg=> $ValueErrorStrg || 'This field cannot be blank'
            },
        );
    }
    ...
    $Output .= $Self->{LayoutObject}->Output(
        TemplateFile => 'AdminDynamicFieldTabularDataField',
        Data         => {
            %Param,
